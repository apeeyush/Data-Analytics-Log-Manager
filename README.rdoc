...
{<img src="https://travis-ci.org/apeeyush/Data-Analytics-Log-Manager.svg?branch=master" alt="Build Status" />}[https://travis-ci.org/apeeyush/Data-Analytics-Log-Manager]
{<img src="https://codeclimate.com/github/apeeyush/Data-Analytics-Log-Manager.png" alt="Code Climate" />}[https://codeclimate.com/github/apeeyush/Data-Analytics-Log-Manager]
...
To allow the rails application to send mails, set the following environment variables found in config/initializers/actionmailer.rb. By default, mail will get stored in files in tmp/mails/.
